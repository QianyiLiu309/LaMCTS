    ...
    def __call__(self, x):
        ...
        for i in range(0, 3):  # controls the number of episode/plays per trial
            ...
            for step in range(num_steps):
                ...
                # value = self.env.step(received_action)
                # print(value)
